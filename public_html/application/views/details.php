...
$adult=$this->session->userdata('adults')??1;
if($checkindate>=date('Y-m-d') && $checkoutdate>$checkindate){
$children=$this->session->userdata('children')??0;
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-sm-12 col-lg-7">
                            ...
                            <swiper-container class="mySwiper" navigation="true" >
                                ...
                                $gallery = $roominfo->room_gallery;
                                
                                if(!empty($gallery)){
                                    $gallery .= ','.$roominfo->room_imagename;
                                    ...
                                    $image = $this->config->base_url().$roominfo->room_imagename;
                                    $rm = $roominfo-room_type;
                                echo "<swiper-slide ><img src='$image'></swiper-slide>";
                                }
