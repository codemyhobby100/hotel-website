        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-body p-5 border-0">
                    <?php echo form_open('hotel/paymentconfirm');?>
                    <div class="row mb-5">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input name="ua" value="<?=$userinfo->customerid?>" type="hidden">
                            <input name="ca" value="<?=$item['id']?>" type="hidden">
                            <button type="submit" id="pay" onclick="makePayment()" class="btn btn-primary"><?php echo display('submit') ?></button>
                        </div>
                    </div>
