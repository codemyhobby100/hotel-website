    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="gallery" class="col-sm-4 col-form-label">Gallery <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="file" accept="image/*" multiple name="gallery[]" onchange="loadFile(event)"><a class="cattooltipsimg" data-toggle="tooltip" data-placement="top" title="Use only .jpg,.jpeg,.gif and .png Images"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
