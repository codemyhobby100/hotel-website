...
$route['room_setting/room-amenities'] = "room_setting/room_amenities/index";
$route['room_setting/room-amenities/create'] = "room_setting/room_amenities/create";
$route['room_setting/amenity-delete/(:num)'] = "room_setting/room_amenities/delete/$1";
